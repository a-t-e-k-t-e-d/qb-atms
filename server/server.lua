...
CreateThread(function()
    while true do
        Wait(3600000)
        dailyWithdraws = {}
        TriggerClientEvent('QBCore:Notify', -1, Lang:t("success.withdraw_limit_reset"), "success")
    end
end)
        ...
        if dailyWith < Config.DailyLimit then
            ...
            if xCH ~= nil then
                ...
                if bankCount > 0 then
                    ...
                    TriggerClientEvent('QBCore:Notify', src, Lang:t("success.much_withdraw") .. data.amount ..  Lang:t('success.daily_withdraws') .. dailyWithdraws[cardHolder], "success")
                else
                    TriggerClientEvent('QBCore:Notify', src, Lang:t("error.need_money"), "error")
                end
            ...
            TriggerClientEvent('QBCore:Notify', src, Lang:t("error.reached_daily_limit"), "error")
        end
    end
end)
